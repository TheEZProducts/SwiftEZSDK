...
///
/// Extends `EZUIPackViewBaseProtocol` with UIKit-specific lifecycle methods and appearance customization.
...
/// }
/// ```
public protocol EZUIPackViewProtocol<Mediator>: EZUIPackViewBaseProtocol {
