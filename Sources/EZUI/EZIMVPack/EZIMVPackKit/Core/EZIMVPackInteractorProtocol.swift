//
//  EZIMVPackInteractorProtocol.swift
//  EZIMVPackKit
//
...
/// ```
@MainActor
public protocol EZIMVPackInteractorProtocol: AnyObject {
...
extension EZIMVPackInteractorProtocol {
...
extension EZIMVPackInteractorProtocol where Context == Void {
    /// Default implementation when `Context` is `Void`.
    public func makeContext() -> Context { () }
}

extension EZIMVPackInteractorProtocol where Mediator.InputI == Void {
    /// Default implementation when `InputI` is `Void`.
    public func makeInput() -> Mediator.InputI { () }
}

extension EZIMVPackInteractorProtocol where Mediator.InputI == Self {
