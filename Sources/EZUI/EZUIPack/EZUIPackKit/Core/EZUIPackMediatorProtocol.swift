...
@MainActor
public protocol EZUIPackMediatorProtocol: EZPackMediatorBaseProtocol, EZUIPackBaseMediatorProtocol {}
...
/// ```
@MainActor
open class EZUIPackMediator: EZPackMediator, EZUIPackBaseMediatorProtocol {
    /// The bridge that connects this mediator to its pack.
    ///
    /// Used internally to maintain the relationship between mediator, pack, and components.
