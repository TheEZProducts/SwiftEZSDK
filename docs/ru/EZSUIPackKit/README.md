...
| `EZSUIPackV` / `EZSUIPackViewProtocol` | Протокол вью, комбинирующий `View` + `EZPackViewBaseProtocol` |
...
- [EZUIPackBaseKit](../../../Sources/EZUI/EZUIPack/EZUIPackBaseKit/) — общие базовые протоколы
- [Исходный код](../../../Sources/EZUI/EZUIPack/EZSUIPackKit/) — реализация модуля
