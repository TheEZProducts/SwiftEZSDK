...
Подробная документация — [Система переходов (EZTransition)](../../EZTransitionKit/README.md).
...
Подробная документация — [EZTransitionAnimations](../../EZTransitionKit/EZTransitionAnimations/README.md).
...
- [Исходный код](../../../../../Sources/EZUI/EZIMVPack/EZUIPackKit/) — реализация модуля
