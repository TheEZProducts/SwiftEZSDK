    ...
    public struct Diagnostic: Codable {
        ...
        public struct FixIt: Codable {
            public struct Change: Codable {
                ...
                public init(range: PositionRange, newText: String) {
                    self.range = range
            ...
            public init(message: String, changes: [Change]) {
                self.message = message
        ...
        public init(message: String, severity: Severity, position: Position, highlights: [PositionRange], notes: [Note], fixIts: [FixIt]) {
            self.message = message
